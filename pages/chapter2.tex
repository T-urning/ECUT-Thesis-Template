...
\begin{figure}
  \centering
  \includegraphics[width=0.3\textwidth]{ecut_logo.jpg}
  \bicaption{插图示例}{Example of inserting a figure}
  \label{fig:whu}
\end{figure}
...
\begin{figure}[h]
  ...
  \begin{subfigure}{0.25\textwidth}
    \includegraphics[width=\linewidth]{ecut_logo.jpg}
    \bicaption{东理校徽}{The logo of\  ECUT}
    \label{fig:subfig-a}
  \end{subfigure}\qquad
  \begin{subfigure}{0.65\textwidth}
    \includegraphics[width=\linewidth]{ecut.png}
    \bicaption{东华理工大学}{East China University of Technology}
    \label{fig:subfig-b}
  \end{subfigure}
  \bicaption{多个分图的示例}{Example of multi-subfigures}
...
\begin{table}[ht]
  \centering
  \bicaption{一般三线表}{A standard three-line table}
  \label{tab:2}
  \begin{tabular}{ccc}
    \toprule
    姓名 & 学号 & 性别 \\
...
\begin{table}[ht]
  \centering
  \bicaption{占满文字宽度的三线表}{A three-line table with full width}
  \label{tab:3}
...
\begin{table}[b]
  \bicaption{模板定义的数学环境}{Mathematical environments defined by the templates}\label{tab:数学环境}
  \begin{tabularx}{\textwidth}{CCCC}
    \toprule
